...
const eventosData = [
    ...
    new EventoPago(1, "Masterclass de Contorno & Iluminación", "2025-03-15", "Auditorio Central", 120.00, "Técnicas avanzadas de contorno y strobing con productos de lujo.", basePath + "evento1.jpg"),
    
    // WORKSHOP -> evento2.png (CORREGIDO A PNG)
    new EventoGratuito(2, "Workshop de Skincare Coreano", "2025-04-01", "Sala Virtual - Zoom", "Rutina completa de 10 pasos para una piel de porcelana.", basePath + "evento2.png"),
    
    // CENA -> evento3.png (CORREGIDO A PNG)
    new EventoPago(3, "Cena de Networking y Belleza", "2025-04-20", "Hotel The Luxury", 25.00, "Un encuentro para conectar con maquilladores y bloggers de belleza. Incluye cóctel.", basePath + "evento3.png"),
    
    // SESIÓN CEJAS -> evento4.png (CORREGIDO A PNG)
    new EventoGratuito(4, "Sesión de Cejas Perfectas", "2025-05-10", "Tienda GLAMOUR", "Aprende a diseñar y rellenar tus cejas como una profesional.", basePath + "evento4.png"), 
];
...
function mostrarDetallesModal(eventoId) {
    ...
    modalContent.innerHTML = `
        <span class="close-modal-btn" onclick="cerrarDetallesModal()">&times;</span>
